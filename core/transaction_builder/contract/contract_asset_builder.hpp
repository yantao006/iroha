...
*/
#ifndef CORE_MODEL_TRANSACTION_BUILDER_CONTRACT_ASSET_HPP
#define CORE_MODEL_TRANSACTION_BUILDER_CONTRACT_ASSET_HPP
...
template <>
class TransactionBuilder<type_signatures::Contract<type_signatures::Asset>> {
 public:
  ...
  Api::Transaction build() {
    ...
    if (not unsetMembers.empty()) {
      throw exception::txbuilder::UnsetBuildArgmentsException("Contract<Asset>",
                                                              unsetMembers);
    }
    Api::Transaction ret;
