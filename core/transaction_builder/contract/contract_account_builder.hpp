...
*/
#ifndef CORE_MODEL_TRANSACTION_BUILDER_CONTRACT_ACCOUNT_HPP
#define CORE_MODEL_TRANSACTION_BUILDER_CONTRACT_ACCOUNT_HPP
...
template <>
class TransactionBuilder<type_signatures::Contract<type_signatures::Account>> {
 public:
  ...
  TransactionBuilder& setSenderPublicKey(std::string sender) {
    if (_isSetSenderPublicKey) {
      throw exception::txbuilder::DuplicateSetArgmentException(
          "Contract<Account>", "senderPublicKey");
    }
