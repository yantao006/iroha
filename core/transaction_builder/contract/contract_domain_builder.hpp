...
*/
#ifndef CORE_MODEL_TRANSACTION_BUILDER_CONTRACT_DOMAIN_HPP
#define CORE_MODEL_TRANSACTION_BUILDER_CONTRACT_DOMAIN_HPP
...
template <>
class TransactionBuilder<type_signatures::Contract<type_signatures::Domain>> {
 public:
  ...
  TransactionBuilder& setSenderPublicKey(std::string sender) {
    if (_isSetSenderPublicKey) {
      throw exception::txbuilder::DuplicateSetArgmentException(
          "Contract<Domain>", "senderPublicKey");
    }
